...
CREATE INDEX idx_habit_schedules_user_id ON public.habit_schedules(user_id);
CREATE INDEX idx_habit_schedules_habit_id ON public.habit_schedules(habit_id);
CREATE INDEX idx_habit_schedules_scheduled_date ON public.habit_schedules(scheduled_date);
CREATE INDEX idx_habit_schedules_user_date ON public.habit_schedules(user_id, scheduled_date);
