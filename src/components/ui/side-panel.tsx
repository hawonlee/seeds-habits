    ...
    >
      ...
      >
        ...
        <div className="p-4 pb-0 flex-shrink-0">
          ...
          <h2 className="text-xs font-medium text-gray-900">Habits</h2>
            <Button
      ...
      {!isCollapsed && (
        <div
          ...
          className={`absolute top-0 h-full w-1 cursor-col-resize select-none ${position === 'right' ? 'left-0' : 'right-0'} ${isResizing ? 'bg-gray-300' : 'bg-transparent hover:bg-gray-200'}`}
          onMouseDown={(e) => {
            e.preventDefault();
            setIsResizing(true);
          }}
