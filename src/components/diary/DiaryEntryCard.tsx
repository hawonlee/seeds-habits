...
export const DiaryEntryCard: React.FC<DiaryEntryCardProps> = ({ entry, onEdit, isActive }) => {
    ...
    return (
         <div
             className={`group bg-habitbg hover:bg-habitbghover transition-all duration-200 ease-in-out rounded-lg p-3 w-full hover:cursor-pointer ${isActive ? 'bg-habitbghover' : 'bg-habitbg'} ${getRowSpan()}`}
